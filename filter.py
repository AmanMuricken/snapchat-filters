...
def get_bbox(points, part):
	...
	return (x,y,w,h)
path = "C:/Users/joean/OneDrive/Desktop/snapchat filters/sprites-20211219T050221Z-001"
dir_ =path+ './sprites/googlies/'
googlies = [f for f in listdir(dir_) if isfile(join(dir_, f))]
i = 0
dir1 =path+ './sprites/clouds/'
...
model = 'C:/Users/joean/OneDrive/Desktop/snapchat filters/filters-20211219T050239Z-001/filters/shape_predictor_68_face_landmarks.dat'
...
while True:
	...
	for face in faces:
		...
		apply_sprite(frame,path+ './sprites/nosepick.png', w2, x2-15, y2+25, incl, ontop = False)
		if mouth_open:
			apply_sprite(frame,path+ './sprites/rainbow.png', w0, x0, y0, incl, ontop = False)
